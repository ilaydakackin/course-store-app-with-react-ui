    ...
    return(
        ...
        <>
           ...
           <TableRow>
                ...
                <TableCell align="right">{currensyTRY.format(subTotal)}</TableCell>               
            </TableRow>
            <TableRow>
                <TableCell align="right" colSpan={5}>Vergi(%20)</TableCell>
                <TableCell align="right">{currensyTRY.format(tax)} </TableCell>               
            </TableRow>
            <TableRow>
                <TableCell align="right" colSpan={5}>Toplam</TableCell>
                <TableCell align="right">{currensyTRY.format(total)} </TableCell>               
            </TableRow>
        </>
